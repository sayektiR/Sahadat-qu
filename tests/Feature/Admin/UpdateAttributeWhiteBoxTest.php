...
class UpdateAttributeWhiteBoxTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_path_1_branch_not_match()
    {
        ...
        $response = $this
            ...
            ->put(
                route(
                    'admin.settings.assessments.assessment-template.attributes.update',
                    [
    ...
    public function test_path_3_update_attribute_success()
    {
        $branch = Branch::create([
            'name' => 'Cabang',
            'address' => 'Alamat',
