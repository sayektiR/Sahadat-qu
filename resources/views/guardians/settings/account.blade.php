<x-layouts.dashboard
    ...
    description="Kelola informasi akun Ketua Lembaga.">
    ...
    <section class="grid gap-6 xl:grid-cols-2">
        <div class="rounded-lg border border-slate-200 bg-white shadow-sm">
            ...
            <form
                method="POST"
                action="{{ route('guardians.settings.profile.update') }}"
                class="space-y-5 p-6">
                @csrf
                @method('PUT')
                <div>
        ...
        <div class="rounded-lg border border-slate-200 bg-white shadow-sm">
            ...
            <form method="POST" action="{{ route('guardians.settings.password.update') }}" class="space-y-5 p-6">
                @csrf
                @method('PUT')
                <div>
                    <label class="block text-sm font-semibold text-slate-900">
