<x-layouts.dashboard title="Data Guru" description="Lihat data guru dari semua cabang.">
    @if ($errors->any())
    ...
    <section class="space-y-6">
        <div class="flex justify-end">
            <form method="GET" action="{{ route('leader.teachers') }}" class="grid w-full gap-2 sm:w-auto sm:grid-cols-[200px_160px_auto]">
                <div class="relative">
        ...
        <div class="overflow-x-auto rounded-lg bg-white shadow-sm">
            <table class="w-full min-w-[800px] text-left">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-8 text-center text-sm text-slate-500">Belum ada data guru.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
