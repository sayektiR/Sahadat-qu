<x-layouts.dashboard title="Dashboard" description="Ringkasan data seluruh cabang Sahadat-Qu.">
    <section class="space-y-6">
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <a href="{{ route('leader.branches') }}" class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm hover:border-blue-950">
            ...
            <a href="{{ route('leader.admins') }}" class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm hover:border-blue-950">
            ...
            <a href="{{ route('leader.students') }}" class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm hover:border-blue-950">
            ...
            <a href="{{ route('leader.teachers') }}" class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm hover:border-blue-950">
        ...
        <div class="grid items-start gap-5 xl:grid-cols-3">
            ...
            <article class="self-start rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div class="space-y-3">
                    @forelse ($recentAssessments as $assessment)
                        <a href="{{ route('leader.assessments.show', $assessment) }}" class="block rounded-lg border border-slate-200 bg-slate-50 p-4 hover:border-blue-950">
            ...
            <article class="self-start rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div class="mt-4 grid gap-3 sm:grid-cols-2">
                    <a href="{{ route('leader.attendance') }}" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 p-4 hover:border-blue-950 hover:bg-blue-950 hover:text-white">
                        <x-icon name="calendar-check" class="h-5 w-5" />
                        <span class="text-sm font-semibold">Presensi</span>
                    </a>
                    <a href="{{ route('leader.assessments') }}" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 p-4 hover:border-blue-950 hover:bg-blue-950 hover:text-white">
                        <x-icon name="clipboard-check" class="h-5 w-5" />
                        <span class="text-sm font-semibold">Penilaian</span>
                    </a>
                    <a href="{{ route('leader.reports') }}" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 p-4 hover:border-blue-950 hover:bg-blue-950 hover:text-white">
                        <x-icon name="file-text" class="h-5 w-5" />
                        <span class="text-sm font-semibold">Rapor</span>
                    </a>
                    <a href="{{ route('leader.admins.create') }}" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 p-4 hover:border-blue-950 hover:bg-blue-950 hover:text-white">
